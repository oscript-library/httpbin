...
Функция ПодготовитьПараметрыСреды()
	...
	Конфигурация = КонфигурацияОСкриптВСоответствие(ПеременныеСреды["OSCRIPT_CONFIG"]);
	...
	ПеременныеСреды["OSCRIPT_CONFIG"] = КонфигурацияОСкриптВСтроку(Конфигурация);

	Возврат ПеременныеСреды;

КонецФункции

Функция КонфигурацияОСкриптВСоответствие(Параметры)
...
Функция КонфигурацияОСкриптВСтроку(Параметры)
